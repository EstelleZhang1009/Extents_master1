...
module.exports = {
    ...
    getReportList: function(req, res) {
        var page = 1;
        var limits = 5;
        if (typeof req.body !== 'undefined' && typeof req.body.query.limits !== 'undefined')
            limits = req.body.query.limits;
        ...
        Project.find({ name: project }).exec(function(err, projects) {
            ...
            Report.find({ project: project }).sort({ startTime: 'desc' }).paginate({ page: page, limit: limits }).populate('project').exec(function(err, reports) {
